...
?>
<link rel="stylesheet" type="text/css" media="all" href="css/style_home_content.css"/>
                            ...
                            for ($i = 0; $i < count($productArr); $i = $i + 3) {
                                if (isset($productArr[$i]->id)) {
                                    ...
                                    if($ratedProducts && count($ratedProducts)>0){
                                        if(array_key_exists($productArr[$i]->seller_product_id, $ratedProducts)){
                                            $fancyClass = 'fancyrd';
                                        ...
                                        <div class="figure-item">
                                            ...
                                            <a
                                                ...
                                                class="vcard <?php echo $force_login; ?>"> <?php if ($productArr[$i]->thumbnail == '') { ?>
                                                    ...
                                                    data-ori-url="images/product/thumbs/<?php echo $img; ?>"
                                                    data-310-url="images/product/thumbs/<?php echo $img; ?>"><em
                                            ...
                                            <ul class="function">
                                                ...
                                                <li class="share item_title"><a href="#"><?php echo $productArr[$i]->product_name; ?></a></li>
                                                <li class="share">
                                                    <button type="button" <?php if ($loginCheck == '') { ?>
                                                            ...
                                                            username="<?php
                                                            if ($productArr[$i]->user_id != '0') {
                                                                $username = $productArr[$i]->full_name;
                                                                echo $productArr[$i]->full_name;
                                                            } else {
                                                ...
                                                <li class="share item_user"><a href="<?php echo 'user/' . $productArr[$i]->user_name; ?>"><?php echo $username; ?></a></li>
                                                <li class="share item_rating"><a href="#"><?php echo round($productArr[$i]->avg_rating, 2); ?> <img src="images/icon_star.png"></a></li>
                                                <li class="view-cmt"><a href="#">5 comments</a></li>
                                            </ul>
                                            <a id="prod_popup_<?php echo $productArr[$i]->seller_product_id; ?>" href="#" item_img_url="images/product/<?php echo $img; ?>"
                                               tid="<?php echo $productArr[$i]->seller_product_id; ?>"
                                               class="button product_id <?php echo $fancyClass; ?>"
                                               <?php if ($loginCheck == '') { ?> require_login="true" <?php } ?> rating="true"><span><i></i>
                                ...
                                if (isset($productArr[$i + 1]->id)) {
                                    ...
                                    $fancyText = LIKE_BUTTON;
                                    if($ratedProducts && count($ratedProducts)>0){
                                        if(array_key_exists($productArr[$i + 1]->seller_product_id, $ratedProducts)){
                                            $fancyClass = 'fancyrd';
                                            $fancyText = LIKED_BUTTON;
                                        }
                                    }
                                    ...
                                    <li class="mid clear product_block"
                                        ...
                                        <div class="figure-item">
                                            ...
                                            <ul class="function">
                                                <li class="list"><a href="#">Add to List</a></li>
                                                <li class="cmt"><a href="#">Comment</a></li>
                                                <li class="share item_title"><a href="#"><?php echo $productArr[$i + 1]->product_name; ?></a></li>
                                                <li class="share">
                                                    <button type="button" <?php if ($loginCheck == '') { ?>
                                                                require_login="true" <?php } ?>
                                                            data-timage="<?php //echo base_url();   ?>images/product/<?php echo $img; ?>"
                                                            ...
                                                            username="<?php
                                                            if ($productArr[$i + 1]->user_id != '0') {
                                                                $username = $productArr[$i + 1]->full_name;
                                                                echo $productArr[$i + 1]->full_name;
                                                            } else {
                                                                $username = 'administrator';
                                                                echo 'administrator';
                                                ...
                                                <li class="share item_user"><a href="<?php echo 'user/' . $productArr[$i + 1]->user_name; ?>"><?php echo $username; ?></a></li>
                                                <li class="share item_rating"><a href="#"><?php echo round($productArr[$i + 1]->avg_rating, 2); ?> <img src="images/icon_star.png"></a></li>
                                                <li class="view-cmt"><a href="#">5 comments</a></li>
                                            </ul>
                                ...
                                if (isset($productArr[$i + 2]->id)) {
                                    ...
                                    $fancyText = LIKE_BUTTON;
                                    if($ratedProducts && count($ratedProducts)>0){
                                        if(array_key_exists($productArr[$i + 2]->seller_product_id, $ratedProducts)){
                                            $fancyClass = 'fancyrd';
                                            $fancyText = LIKED_BUTTON;
                                        }
                                    }
                                    ...
                                    <li class="mid product_block"
                                        ...
                                        <div class="figure-item">
                                            ...
                                            <ul class="function">
                                                <li class="list"><a href="#">Add to List</a></li>
                                                <li class="cmt"><a href="#">Comment</a></li>
                                                <li class="share item_title"><a href="#"><?php echo $productArr[$i + 2]->product_name; ?></a></li>
                                                <li class="share">
                                                    <button type="button" <?php if ($loginCheck == '') { ?>
                                                                require_login="true" <?php } ?>
                                                            data-timage="<?php //echo base_url();   ?>images/product/<?php echo $img; ?>"
                                                            ...
                                                            username="<?php
                                                            if ($productArr[$i + 2]->user_id != '0') {
                                                                $username = $productArr[$i + 2]->full_name;
                                                                echo $productArr[$i + 2]->full_name;
                                                            } else {
                                                                $username = 'administrator';
                                                                echo 'administrator';
                                                ...
                                                <li class="share item_user"><a href="<?php echo 'user/' . $productArr[$i + 2]->user_name; ?>"><?php echo $username; ?></a></li>
                                                <li class="share item_rating"><a href="#"><?php echo round($productArr[$i + 2]->avg_rating, 2); ?> <img src="images/icon_star.png"></a></li>
                                                <li class="view-cmt"><a href="#">5 comments</a></li>
                                            </ul>
                                            <a href="#" item_img_url="images/product/<?php echo $img; ?>"
                                               tid="<?php echo $productArr[$i + 2]->seller_product_id; ?>"
