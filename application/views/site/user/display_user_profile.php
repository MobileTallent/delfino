    ...
    <div class="wrapper-content right-sidebar">
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            <li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>" class="current"><b><?php echo LIKED_BUTTON;?></b> <small><?php echo count($ratedProducts);?></small></a></li>
         ...
         <?php 
         	if ($featureProductDetails->num_rows() == 1){
                ...
                if($ratedProducts && count($ratedProducts)>0){
                    if(array_key_exists($featureProductDetails->row()->seller_product_id, $ratedProducts)){
                        $fancyClass = 'fancyrd';
          ...
          ?>
            <div class="figure-item"> <a href="<?php echo $turl;?>" class="vcard"><img src="images/product/<?php echo $imgName;?>"></a> <a href="<?php echo $turl;?>" class="figure-img"> <span class="figure"><img src="images/product/<?php echo $imgName;?>" style="width:100%;" /><em class="back"></em></span> <span class="figcaption"><?php echo $featureProductDetails->row()->product_name;?></span> </a>
              ...
              <a id="prod_popup_<?php echo $featureProductDetails->row()->seller_product_id; ?>" href="#" item_img_url="images/product/<?php echo $imgName;?>" tid="<?php echo $featureProductDetails->row()->seller_product_id;?>" class="button <?php echo $fancyClass;?>" <?php if ($loginCheck==''){?>require_login="true"<?php }?> rating="true"><span><i></i></span> <?php echo $fancyText;?></a> </div>
